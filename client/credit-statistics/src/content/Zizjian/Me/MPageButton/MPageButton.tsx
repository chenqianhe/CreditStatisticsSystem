...
export class MPageButton extends React.Component<ButtonProp,ButtonState> {
    ...
    render() {
        return (
            <div className="Me_bottom_box">
                ...
                <div id={"Me_bottom_item2"} style={{order:2,userSelect:"none"}}>{  this.props.totalPage > 0 ? this.state.pagenum : 0 }页/ { this.props.totalPage }页</div>
